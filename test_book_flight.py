...
class BookFlight(unittest.TestCase):
    ...
    def test_book_flight(self):
        ...
        Select(wd.find_element_by_name("fromPort")).select_by_visible_text("London")
        wd.find_element_by_name("fromMonth").click()
        Select(wd.find_element_by_name("fromMonth")).select_by_visible_text("April")
        wd.find_element_by_name("fromDay").click()
        Select(wd.find_element_by_name("fromDay")).select_by_visible_text("10")
        ...
        Select(wd.find_element_by_name("toDay")).select_by_visible_text("27")
        wd.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Airline:'])[1]/preceding::input[2]").click()
        ...
        wd.find_element_by_name("passFirst0").send_keys("helen")
        wd.find_element_by_name("passLast0").clear()
        wd.find_element_by_name("passLast0").send_keys("harrison")
        ...
        wd.find_element_by_name("creditnumber").send_keys("57893857")
        ...
        wd.find_element_by_name("cc_frst_name").send_keys("helen")
        wd.find_element_by_name("cc_last_name").clear()
        wd.find_element_by_name("cc_last_name").send_keys("harrison")
        wd.find_element_by_name("billAddress1").clear()
        wd.find_element_by_name("billAddress1").send_keys("11 kittiwake drive")
        wd.find_element_by_name("billCity").clear()
        wd.find_element_by_name("billCity").send_keys("aucklad")
        ...
        wd.find_element_by_name("billZip").send_keys("5647")
        ...
        wd.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='$588 USD'])[1]/following::img[4]").click()
